package com.iot.jesseboyd.savingdatawithsqlight;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recordsTextView = (TextView) findViewById(R.id.dbView);
    ...
    public void printDatabase(){
        ...
        userInput.setText("");  // clear input field after posting to db
    }
